...
# C:\Users\caiod\pythonPOO\modulosPy\aula281.py

caminho = os.path.join('C:\\Users\\caiod\\pythonPOO\\modulosPy', 'aquivo.txt')
# print(caminho)
...
print(os.path.exists('C:\\Users\\caiod\\pythonPOO\\modulosPy'))
